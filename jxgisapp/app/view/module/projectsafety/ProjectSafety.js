    ...
    items: [
        {
            ...
            format: 'Y-m-d',
            labelWidth: 60,
            reference: 'queryProjSafetyStartDate',
            emptyText: '请选择起始时间',
            allowBlank: false,
        ...
        },
        {
            ...
            format: 'Y-m-d',
            labelWidth: 60,
            reference: 'queryProjSafetyEndDate',
            emptyText: '请选择起始时间',
            allowBlank: false,
        ...
        },
        {
            ...
            columns: [
                ...
                {text: '水平偏移', dataIndex: 'rate', flex: 1},
            ],
            store: {
                proxy: {
                    type: 'ajax',
                    url: 'resources/json/projectsafety.json'//TODO 2018-04-23---测试本地数据加载，加载后台服务需要屏蔽该行代码。
